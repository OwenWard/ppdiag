...
## Plot
### drawHPIntensity(object, start, end, history, t, color = 1, i = 1, add=FALSE) takes a hp object, start and end time of events, history, event times vector, and plots its intensity
```{r}
drawHPIntensity(fit_hp, start=min(time), end=max(time), history=0, t=time)
```
