...
par(mfrow=c(1,2))
hist(s1,main="sample sim of 10 hpp events")
temp=s1
...
s1=simulatehpp(hpp(lambda=3,n=50))
par(mfrow=c(1,2))
hist(s1,main="sample sim of 50 hpp events")
temp=s1
inter_s1=s1[2:length(s1)]-temp[1:length(temp)-1]
hist(inter_s1,main="interevent times")

# sample simulation of 100 hpp events
s1=simulatehpp(hpp(lambda=1,n=100))
par(mfrow=c(1,2))
hist(s1,main="sample sim of 100 hpp events")
temp=s1
inter_s1=s1[2:length(s1)]-temp[1:length(temp)-1]
hist(inter_s1,main="interevent times")
```
