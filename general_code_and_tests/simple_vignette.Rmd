...
hist(s1,main="sample simulation of 10 hpp events")

# sample simulation of 50 hpp events
s2=simulatehpp(hpp(lambda=1,n=50))
hist(s2,main="sample simulation of 50 hpp events")

# sample simulation of 100 hpp events
s3=simulatehpp(hpp(lambda=1,n=100))
hist(s3,main="sample simulation of 100 hpp events")
```
