...
drawUniMMHPIntensity <- function(mmhp, simulation, yupper = 10, add = FALSE, color = 1,
  ...
  for (i in 1:(m - 1)) {
    if (state[i] == 1) {
      ...
      hawkes_obj <- list(lambda0 = lambda1,alpha = alpha,beta = beta)
      drawHPIntensity(hp_obj = hawkes_obj, hawkes_time,
