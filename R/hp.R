...
#' @param events vector containing the event times. Note that the first event is at time zero. Alternatively, t could be specified as NULL, meaning that the data will be added later (e.g. simulated).
